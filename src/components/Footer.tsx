        ...
        <div className='grid grid-cols-2 lg:flex lg:flex-row lg:gap-20 mt-10 lg:mt-0 gap-5'>
          ...
          <div className={`${mobileBoxClasses} lg:p-0 lg:border-none lg:rounded-none lg:min-h-0`}>
            ...
            <ul className={`space-y-4 text-[12px] lg:text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
              ...
              <li> <Link href="/" className='hover:underline'>Case studies CMS</Link> </li>
              <li> <Link href="/" className='hover:underline'>Blog</Link> </li>
              <li> <Link href="/" className='hover:underline'>Blog post CMS</Link> </li>
          ...
          <div className={`${mobileBoxClasses} lg:p-0 lg:border-none lg:rounded-none lg:min-h-0 col-span-2 lg:col-span-1`}>
            ...
            <ul className={`space-y-4 text-[12px] lg:text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
              ...
              <Link href="www.instagram.com" target='_blank' className='flex items-center gap-3'>
                <span className='bg-[#171717] p-1.5 rounded-full'>
              ...
              <Link href="www.x.com" target='_blank' className='flex items-center gap-3'>
                <span className='bg-[#171717] p-1.5 rounded-full'>
              ...
              <Link href="www.linkedin.com" target='_blank' className='flex items-center gap-3'>
                <span className='bg-[#171717] p-1.5 rounded-full'>
