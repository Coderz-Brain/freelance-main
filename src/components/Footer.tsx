...
const Footer = () => {
  ...
  const mobileBoxClasses = "rounded-lg w-full";

  return (
    <div className="mx-auto w-full lg:p-0">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between mb-10 pt-5 lg:pt-0">
        <div className="flex flex-col w-full lg:w-auto lg:flex-col lg:justify-between gap-8 lg:gap-0">
          ...
          <div className="w-full flex flex-col gap-4 bg-[#cbfb45] lg:mt-14 p-4 rounded-[20px] mt-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              />
              <button className="text-white bg-[#171717] px-6 py-2 rounded-full text-sm">
                {" "}
                Subscribe{" "}
              </button>
            </div>
        ...
        <div className="grid grid-cols-2 lg:flex lg:flex-row lg:gap-20 mt-10 lg:mt-0 gap-5">
          <div
            className={`${mobileBoxClasses} lg:p-0 lg:border-none lg:rounded-none lg:min-h-0`}
          >
            <h4 className="font-semibold mb-6">Quick Links</h4>
            <ul
              className={`space-y-4 text-[12px] lg:text-sm ${
          ...
          >
            ...
            <ul
              className={`space-y-4 text-sm lg:text-[12px] ${
                darkMode ? "text-gray-300" : "text-gray-600"
              }`}
            >
              ...
              <li className="max-w-[200px]">
                VisionCode Office Complex 13 Imaginary Street Manchester
              </li>
            </ul>
          </div>

          <div
            className={`${mobileBoxClasses} lg:p-0 lg:border-none lg:rounded-none lg:min-h-0 col-span-2 lg:col-span-1`}
          >
            ...
            >
              ...
              >
                ...
                <span className="hover:underline">X</span>
              </Link>
